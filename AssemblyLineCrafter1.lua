...
local function CraftZPMEmitter()
	GoToCoords(-1,4,0)
	SetOrientation("X-")
	robot.select(1)
	inv.suckFromSlot(1)
...
while true do
    for i = 4980, 4994 do
		...
		elseif i == 4991 and result then
			CraftLuVEmitter()
		elseif i == 4992 and result then
			CraftZPMMotor()
		elseif i == 4993 and result then
			CraftZPMPump()
		elseif i == 4994 and result then
			CraftZPMEmitter()
		end
	end
    os.sleep(5)
